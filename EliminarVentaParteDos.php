...
<div class= "e">
    ...
    <div class="a"></div>
    <form method="POST" class="eliminarParteDos"   action="MenuVentas.php">
        <?php
           $venta=$_POST['idVenta'];
           $consulta = "DELETE FROM ventas WHERE id_venta='".$venta."'  ";
           $query= mysqli_query($conn, $consulta)or die("".mysqli_error($conn));
        ?>
        <h2>Se ha realizado la eliminacion con exito!!</h2>
