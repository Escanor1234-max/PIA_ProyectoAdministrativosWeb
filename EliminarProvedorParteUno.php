...
<body background="Imagenes/fondo.jpg" style="overflow-x:hidden; overflow-y:hidden;">
    ...
    <div class="a"></div>
    <form class="eliminar" method="POST" action="EliminarProvedorParteDos.php">
        <p>ID_Provedor:<select id="idpr" name="idProvedor">
            <?php
            ...
            ?>
            <option></option>
            <option value="<?=$mostrarProvedor['id_provedor'] ?>" ><?= $mostrarProvedor['id_provedor'] ?></option>
            <?php } ?>
        </select></p>
